...
class CalcMaterial(Base):
    ...
    price_per_m2: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=0)
...
class CalcCalculation(Base):
    ...
    markup_percent: Mapped[float] = mapped_column(Float, default=30)  # % — float OK
...
class CalcItem(Base):
    ...
    flange_cost: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=0)
